...
def _(count, filtered_portfolio, mo, pd, px):
    ...
    #=========================================
    # Plot 1: The Financial Analysis (Line chart)
    #=========================================
...
@app.cell
def _(cap_slider, chart_element, count, fig_travel, mo, sector_dropdown):
    ...
    tab_cv = mo.md(
        """
        ### Aspiring Financial Analyst | Data-Driven Decision Maker

        **Profile:**
        - Accounting & Finance student with a strong intrest in investment analysis and 
        using data to support financial decisions. I enjoy building and improving my skills on 
         platforms such as Python, Excel and financial modelling, to apply analytical thinking to real
         world problems.
        ...
        **Skills:**
        *   🐍 Python programming (Pandas, Marimo)
    ...
    tab_personal = mo.vstack([
        ...
        * Gaming 
         ...
         These interests help me stay mentally and physically active whilst also just having 
          fun
        """
